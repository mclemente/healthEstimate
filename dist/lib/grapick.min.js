...
!function (e, t) {
	...
	return function (e) {
		...
		var s     = function () {
		...
		}(), c    = n(3), u = i(c), h = n(4), d = i(h), f = n(0), v = function (e, t) {
			...
			return l(t, e), s(t, [{
				...
				key: "getValue", value: function (e, t) {
					var n = this.getColorValue(), i = e || this.getType(), r = t || this.getDirection()
					return n ? i + "-gradient(" + r + ", " + n + ")" : ""
				}
			}, {
				key: "getSafeValue", value: function (e, t) {
					var n = this.previewEl, i = this.getValue(e, t)
				...
				key: "setValue", value: function () {
					var e                                                                          = this, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
					    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = this.type,
					    r                                                                          = this.direction, o                                                      = t.indexOf("(") + 1, a = t.lastIndexOf(")"), l = t.substring(o, a),
					    s                                                                          = l.split(/,(?![^(]*\)) /)
					...
					["repeating-linear", "repeating-radial", "linear", "radial"].forEach(function (e) {
						...
						var i = t.split(" "), r = parseFloat(i.pop()), o = i.join("")
				...
				key: "initEvents", value: function () {
					var e = this, t = this.options, n = t.min, i = t.max, r = this.previewEl, o = 0, a = {}
					r && /*(0, f.on)(*/r.addEventListener("click", function (t) {
						a.w = r.clientWidth//, a.h = r.clientHeight
						var l = t.offsetX - r.clientLeft//, s = t.offsetY - r.clientTop
						let smooth
						if (document.getElementById('smoothGradient').checked) {
							smooth = 100
						} else {
							smooth = game.settings.get('healthEstimate', 'core.stateNames').split(/[,;]\s*/).length
						}
				...
				key: "render", value: function () {
					var e = this.options, t = this.el, n = e.pfx, i = e.height, r = e.width
					if (t) {
						var o       = n + "-wrapper", a = n + "-preview"
						t.innerHTML = '\n      <div class="' + o + '">\n        <div class="' + a + '"></div>\n      </div>\n    '
						var l       = t.querySelector("." + o), s = t.querySelector("." + a), c = l.style
		...
		var r     = function () {
			...
			return r(e, [{
				...
				key: "setPosition", value: function (e) {
					var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, n = this.getEl()
				...
				key: "remove", value: function () {
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = this.getEl(),
					    n                                                                          = this.gp.getHandlers(), i                                               = n.splice(n.indexOf(this), 1)[0]
				...
				key: "initEvents", value: function () {
					var e = this, t = this.getEl(), n = this.gp.previewEl, i = this.gp.options, r = i.min, a = i.max,
					...
					if (s && (0, o.on)(s, "click", function (e) {
						...
						var n = t.target, i = n.value
						e.setColor(i), c && (c.style.backgroundColor = i)
					}), h) {
						var d = 0, f = 0, v = 0, g = {}, p = {}, y = {}, m = function (t) {
				...
				key: "render", value: function () {
					var e = this.gp, t = e.options, n = e.previewEl, i = e.colorPicker, r = t.pfx, o = t.colorEl,
					    a                                                                            = this.getColor()
					if (n) {
						var l = document.createElement("div"), s = l.style, c = r + "-handler"

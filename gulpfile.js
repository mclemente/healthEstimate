...
function buildWatch() {
	...
	gulp.watch('src/lang/*.yml', { ignoreInitial: false }, buildYaml);
	gulp.watch(
...
function updateManifest(cb) {
	...
	try {
		...
		const result = `${repoURL}/releases/download/${manifest.file.version}/${manifest.file.name}-v${manifest.file.version}.zip`;
